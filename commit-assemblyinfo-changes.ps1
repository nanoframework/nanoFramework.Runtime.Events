...
if ($env:APPVEYOR_REPO_TAG -eq "true")
{
    ...
    $nativeFile = "nf_rt_events_native.cpp"
    ...
    # new branch name
    $newBranch = "$env:APPVEYOR_REPO_BRANCH-nfbot/update-version/nanoFramework.Runtime.Events/$env:MyNuGetVersion"
    ...
    {
        $commitMessage = "Update nanoFramework.Runtime.Events version to $env:MyNuGetVersion"
